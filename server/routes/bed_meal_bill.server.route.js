...
module.exports = function (app) {
  app.route('/bed_meal_bills').post(authFilter.requireUser, bedMealRecordFilter.requireMealRecords, goodsFilter.requireAllHealthyMeals, bedFilter.requireBuilding, bedFilter.requireFloor, bedMealBillController.batchCreateBills);
  app.route('/bed_meal_bills').get(authFilter.requireUser, hospitalizedInfoFilter.requireHospitalizedInfo, bedMealBillController.queryBedMealBillsByFilter);
