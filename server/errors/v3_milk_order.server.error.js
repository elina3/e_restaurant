...
module.exports = _.extend(exports, {
  amount_invalid: {type: 'amount_invalid', message: 'The order amount is invalid!', zh_message: '该牛奶棚订单金额不正确'},
  actual_amount_invalid: {type: 'actual_amount_invalid', message: 'The order discount amount is invalid!', zh_message: '该牛奶棚订单折扣金额不正确'},
  supermarket_consumption_amount_not_enough: {type: 'supermarket_consumption_amount_not_enough', message: 'The amount is not enough for supermarket consumption!Only {{value1}} yuan for supermarket consumption this month！', zh_message: '牛奶棚消费余额不足，当月仅剩{{value1}}元供牛奶棚消费'},
