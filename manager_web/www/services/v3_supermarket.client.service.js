'use strict';
angular.module('EWeb').factory('SupermarketOrderService', ['RequestSupport', 'SystemError', function (RequestSupport, SystemError) {
  return {
    ...
    getSupermarketOrders: function(param, filter, timeRangeString, callback){
      RequestSupport.executeGet('/user/supermarket_orders', {
